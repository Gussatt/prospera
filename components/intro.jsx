	...
	return(
		<section className="flex w-11/12 mx-auto items-center justify-evenly mt-12 flex-col md:items-start md:flex-row">
			<div className="flex flex-col h-full flex-1 w-5/6 md:w-2/6">
				<h3 tabIndex={0} className="text-clamp-title text-header text-center md:text-left">
				...
				<h3 tabIndex={0} className="text-clamp-title text-header mt-12 text-center md:mt-24 md:text-left">
			...
			<div className="w-5/6 h-[50vh] flex mt-8 flex-1 flex-col justify-end relative md:mt-0 md:w-2/6 md:h-[100vh]">
				...
				<div className="flex flex-col items-center justify-between bg-blue h-56 w-6/12 rounded-xl absolute bottom-[-4rem] p-4 left-5 md:w-5n/12 md:left-8 lg:left-[-4rem] ">
					<h4 tabIndex={0} className="text-center text-clamp-label font-bold text-header">
						Meu portfólio
					</h4>

					<span tabIndex={0} className="text-center text-clamp-label text-header">
                    ...
                    <AiOutlineLineChart 
                        color="#fafafa"
                        size={48}
						aria-label={"Ícone de gráfico de investimentos"}
						tabIndex={0}
                    />
				</div>
			</div>
